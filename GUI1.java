...
public class GUI1 extends JPanel
{
	...
	// *** find it.
	/*
	 * private void writeToFile() { String fileName = "textFile.txt"; String
	 * line = null; int count; Scanner scan = new Scanner(System.in);
	 * PrintWriter textStream = TextFileIO.createTextWrite(fileName);
	 * System.out.println("Enter 4 lines of text:"); for (count = 1; count <= 4;
	 * count++) { line = scan.nextLine(); textStream.println(count + " " +
	 * line); } textStream.close( ); //*** did not require error handling
	...
	class add5Button implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			answerLabel.setText(stringNumber);// *** answerLabel gets a new
												// value
	...
	class nextNumberButton implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			inputTextField.setText("");// *** erases the values of this
										// JTextField
